		...
		<div class="explore__topbar">
			...
			<div class="explore__toolbar">
				<div class="explore__nav">
					<button
						class="explore__toolbar-btn explore__toolbar-btn--disabled"
						type="button">
		...
		<div class="explore__body">
			...
			<div class="explore__sidebar">
				<div class="explore__sidebar-inner">
					<h2 class="explore__sidebar-title"> Quick Access </h2>
										...
										<template
											...
											<div v-if="subchild.type === 'folder'">
												<div
													...
													<span
														class="explore__tree-icon"
														aria-hidden="true">
														<xIcon icon="folder" :size="16" />
													</span>
													<span class="explore__tree-label">{{
														subchild.name
													}}</span>
												</div>
											</div>
			...
			<div class="explore__main">
				...
				<div class="explore__file-list" @click="selectedFile = null">
					<div v-if="filteredAndSortedFiles.length === 0" class="explore__empty-state">
				...
				<div v-else class="explore__preview-inner">
					...
					<div
						...
						<xIcon
							...
							icon="picture"
							:size="64"
							class="explore__preview-placeholder" />
					</div>
					<div
						v-else-if="selectedFile.type === 'document' || selectedFile.type === 'code'"
						class="explore__preview-code">
						<pre class="explore__preview-code-pre">{{
							selectedFile.content || "No content available."
						}}</pre>
					</div>
					<div v-else-if="selectedFile.type === 'folder'" class="explore__preview-folder">
						<xIcon
							icon="folder"
							:size="80"
							class="explore__icon explore__icon--folder" />
					</div>
					<div v-else class="explore__preview-generic">
					...
					<p class="explore__preview-subtitle">{{ selectedFile.type }}</p>

					<div class="explore__preview-meta">
						<div class="explore__preview-section">
							<h4 class="explore__preview-section-title"> Information </h4>
...
.explore {
	...
	&__preview-folder {
		background: color-mix(
			in srgb,
			var(--color-primary-container) 42%,
