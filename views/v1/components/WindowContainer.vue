<template>
	<div class="window-container" :style="cptWindowStyle" @mousedown="handleFocus">
		<!-- Title Bar (Drag Handle) -->
		<div class="window-container__titlebar" @dblclick="handleToggleMaximize">
			...
			<div class="window-container__controls" @mousedown.stop>
				<button
					class="window-container__control-btn"
				...
				<button
					class="window-container__control-btn window-container__control-btn--close"
					@click="handleClose"
					title="Close">
