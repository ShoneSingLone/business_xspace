...
.file-item__name {
	...
	white-space: normal !important; /* 确保在所有模式下都能换行 */
}
...
.file-browser--grid .file-item__preview {
	width: 100% !important;
	height: auto !important;
...
.viewer-image__interval::-webkit-inner-spin-button {
	display: none;
}
